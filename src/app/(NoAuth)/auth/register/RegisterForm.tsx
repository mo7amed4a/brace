  ...
  return (
    <div className="w-full max-w-md mx-auto px-4">
      <div className="text-center mb-6">
        <h1 className="text-3xl font-bold text-white mb-2">New Account</h1>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="space-y-1">
          <label htmlFor="password2" className="block text-sm text-white">
            Confirm Password:
          </label>
          <div className="relative">
            <input
        ...
        <div className="flex flex-col gap-2">
          ...
          <span className="text-xs text-gray-400">Maximum file size allowed is 2MB, supported file formats include .jpg, .png, and .pdf.</span>
          <input type="file" className="w-40 text-white cursor-pointer bg-gray-800 p-2 text-xs rounded " />
        </div>
